...
export async function POST(req: NextRequest) {
  ...
  const systemPrompt = `
You are a flashcard generator. Given a topic, generate ${n} flashcards in JSON array format.
Each flashcard should have: question, options (array of 4), and correctAnswer.
